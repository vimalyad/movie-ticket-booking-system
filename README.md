Here is the complete `README.md` for your Movie Ticket Booking System. It includes a comprehensive overview of the
architecture, the design patterns used, and a highly detailed Mermaid class diagram mapping out every class, interface,
enum, and their exact relationships (Composition, Aggregation, Association, and Implementation).
